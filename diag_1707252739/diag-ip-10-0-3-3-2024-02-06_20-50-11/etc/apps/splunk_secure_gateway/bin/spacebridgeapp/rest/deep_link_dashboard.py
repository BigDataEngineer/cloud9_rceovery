...
class DeepLinkDashboardHandler(async_base_endpoint.AsyncBaseRestHandler):
    ...
    def __init__(self, command_line, command_arg):
        ...
        self.log = setup_logging(SPACEBRIDGE_APP_NAME + ".log", "rest_deep_link")
    ...
    async def post(self, request):
        ...
        try:
            credentials = generate_jwt_token(self.log, user, system_authtoken)
        ...
        try:
            version_get_response = build_version_get_response(self.log,
            ...
            self.log.exception("exception fetching environment metadata")
        ...
        deep_link_query_params = build_dashboard_deep_link_query_params(encryption_context=encryption_context,
                                                                        user=user,
        ...
        return {STATUS: http.HTTPStatus.OK,
                PAYLOAD: {DEEPLINK: deep_link, EXPIRES_IN: REGISTRATION_LIFETIME}}


def build_dashboard_deep_link_query_params(encryption_context: SplunkEncryptionContext,
                                           user: str,
                                           asset_type: str,
