...
from spacebridgeapp.util.constants import SPACEBRIDGE_APP_NAME, STATUS, PAYLOAD, SESSION, USER, AUTHTOKEN, BODY, MESSAGE
...
class EnableTokensHandler(BaseRestHandler, PersistentServerConnectionApplication):
    ...
    def __init__(self, command_line, command_arg):
        ...
        self.log = setup_logging(SPACEBRIDGE_APP_NAME + ".log", "enable_tokens")
