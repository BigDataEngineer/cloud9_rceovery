...
class extractCSPHeaders(unittest.TestCase):
    ...
    def test_empty_allowed_domains(self):
        ...
        expected_csp_header = "img-src 'self' data: blob: *.splunk.com"
    ...
    def test_valid_allowed_domains(self):
        ...
        expected_csp_header = "img-src 'self' data: blob: *.splunk.com *.google.com 1.60.2.4"
        self.assertEqual(actual_csp_header, expected_csp_header)
    ...
    def test_invalid_allowed_domains(self):
        ...
        expected_csp_header = "img-src 'self' data: blob: *.splunk.com something invalid is here"
        self.assertEqual(actual_csp_header, expected_csp_header)
