...
def send_notification_to_device(log: logging.Logger,
    ...
    try:
        ...
        response = spacebridge_service.send_notification_request(sender_info.sender_id_hex, notification_request)
...
class ReportNotificationHandler(async_base_endpoint.AsyncBaseRestHandler):
    ...
    def __init__(self, command_line, command_arg):
        ...
        self.log = setup_logging(constants.SPACEBRIDGE_APP_NAME + ".log", "report_notification_send")
